...
my $RepeatMaskerPath = "/cluster/bin/RepeatMasker";
my $RepeatMasker = "$RepeatMaskerPath/RepeatMasker";
my $liftRMAlign = "/cluster/group/evodevo/bin/x86_64/liftRMAlign.pl";
...
tail -n +4 $db.fa.out \\
| splitFileByColumn -col=5 stdin $HgAutomate::gbdb/$db -chromDirs \\
